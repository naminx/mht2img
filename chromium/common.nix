...
let
  ...
  base = rec {
    ...
    patches = [
      ./patches/chromium-123.0.6312.122-to-thorium-123.0.6312.123.patch
    ...
    configurePhase = ''
      ...
      cp -r out/thorium/* out/Release/
      cp ${./out/thorium}/* out/Release/
      cp -r ${./components/vector_icons/thorium} components/vector_icons/
